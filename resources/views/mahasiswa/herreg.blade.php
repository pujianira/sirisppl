            ...
            <div class="max-w-full mx-auto sm:px-6 lg:px-8">
                <div class="flex space-x-4">
                    <div class="flex flex-col w-full space-y-4">
                        <div class="bg-gradient-to-r from-gray-400 to-gray-500 overflow-hidden shadow-sm sm:rounded-lg w-full h-48 flex justify-center items-center">
                ...
                <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg w-full h-48 mt-4">
                    <div class="p-4 text-white text-3xl">
                        {{ __("Her-Registrasi") }}
                    </div>
