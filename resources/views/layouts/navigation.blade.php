    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('mahasiswa.herreg')" :active="request()->routeIs('mahasiswa.herreg')">
                        {{ __('HER-Registrasi') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('mahasiswa.akademik')" :active="request()->routeIs('mahasiswa.akademik')">
                        {{ __('Akademik') }}
                    </x-nav-link>
                </div>
            </div>
